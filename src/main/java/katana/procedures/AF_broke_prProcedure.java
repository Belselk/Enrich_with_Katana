...
public class AF_broke_prProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z) {
		if (EnrichWithKatanaModBlocks.ALLOY_FURNACE.get() == (world.getBlockState(new BlockPos(x, y, z))).getBlock()) {
			...
			if (world instanceof Level _level && !_level.isClientSide()) {
				ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(EnrichWithKatanaModBlocks.ALLOY_FURNACE.get()));
			...
			if (world instanceof Level _level && !_level.isClientSide()) {
				ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(EnrichWithKatanaModBlocks.HELL_FURNACE.get()));
				entityToSpawn.setPickUpDelay(10);
				_level.addFreshEntity(entityToSpawn);
			}
			world.destroyBlock(new BlockPos(x, y, z), false);
