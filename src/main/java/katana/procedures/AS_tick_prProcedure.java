...
public class AS_tick_prProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		}.getItemStack(0, itemstack))).getCount() && 0 == itemstack.getOrCreateTag().getDouble("cooltime") && itemstack.getOrCreateTag().getBoolean("Auto")) {
			{
				Entity _ent = entity;
		...
		if (0 < itemstack.getOrCreateTag().getDouble("cooltime")) {
			itemstack.getOrCreateTag().putDouble("cooltime", (itemstack.getOrCreateTag().getDouble("cooltime") - 1));
		}
	}
}
